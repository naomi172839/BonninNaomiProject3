...
final class Sequence {
    ...
    //takes one argument that corresponds to n.  Returns an int that corresponds to the nth value
    ...
    //corresponds to n.  Returns an int that corresponds to the nth value in the sequence.
